(() => {
    ...
    function initSliders() {
        ...
        //!slider #4 about gallery#2
                if (document.querySelector(".gallery__slider2")) {
            new swiper_core_Swiper(".gallery__slider2", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 1.75,
...
***************************************************************************** */
    ...
    if (beforeAfter) {
        ...
        const afterItem = document.querySelector(".before-after__image--after");
        beforeAfter.addEventListener("mouseover", (function(e) {
            const targetElement = e.target;
            if (!targetElement.classList.contains("before-after__arrow")) if (targetElement.closest(".before-after__image--before")) {
